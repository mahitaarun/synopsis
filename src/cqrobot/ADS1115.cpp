 ...
 */
void ADS1115::setAddr_ADS1115(uint8_t i2cAddress)
{
...
void ADS1115::setCompQue(eADSCompQue_t value){
    int16_t    conf;
...
void ADS1115::setCompLat(eADSCompLat_t value){
    int16_t    conf;
    conf = readAdsReg(ads_i2cAddress, DFROBOT_ADS1115_POINTER_CONFIG);
...
void ADS1115::setCompPol(eADSCompPol_t value){
    int16_t    conf;
    conf = readAdsReg(ads_i2cAddress, DFROBOT_ADS1115_POINTER_CONFIG);
...
void ADS1115::setCompMode(eADSCompMode_t value){
    int16_t    conf;
    conf = readAdsReg(ads_i2cAddress, DFROBOT_ADS1115_POINTER_CONFIG);
...
void ADS1115::setRate(eADSRate_t value){
    int16_t    conf;
    conf = readAdsReg(ads_i2cAddress, DFROBOT_ADS1115_POINTER_CONFIG);
...
void ADS1115::setMode(eADSMode_t value){
    int16_t    conf;
    conf = readAdsReg(ads_i2cAddress, DFROBOT_ADS1115_POINTER_CONFIG);
...
void ADS1115::setGain(eADSGain_t value){
    int16_t    conf;
    conf = readAdsReg(ads_i2cAddress, DFROBOT_ADS1115_POINTER_CONFIG);
...
void ADS1115::setMux(eADSMux_t value){
    int16_t    conf;
    conf = readAdsReg(ads_i2cAddress, DFROBOT_ADS1115_POINTER_CONFIG);
...
void ADS1115::setOSMode(eADSOSMode_t value){
    int16_t    conf;
    conf = readAdsReg(ads_i2cAddress, DFROBOT_ADS1115_POINTER_CONFIG);
 ...
 */
/**************************************************************************/
int16_t ADS1115::ComparatorVoltage(uint8_t channel)
{
...
void ADS1115::writeReg(uint8_t i2cAddress, uint8_t reg, uint8_t *pBuf, uint16_t len)
{
    _pWire->begin();
...
void ADS1115::readReg(uint8_t i2cAddress, uint8_t reg, uint8_t *pBuf, uint16_t len)
{
    _pWire->begin();
    _pWire->beginTransmission(i2cAddress);
    _pWire->write(reg);
...
int16_t ADS1115::readAdsReg(uint8_t i2cAddress, uint8_t reg)
{
    uint8_t buf[2] = {0};
...
void ADS1115::writeAdsReg(uint8_t i2cAddress, uint8_t reg, uint16_t value)
{
